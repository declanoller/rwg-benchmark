...
for p_r_d in params_results_dict_list:
    ...
    d[p_r_d['env_name']][param_str] = '{:.1f}'.format(p_r_d['total_runtime'])
    total_runtime += p_r_d['total_runtime']
    #d[p_r_d['env_name']][param_str] = '{:.1f}'.format(p_r_d['percentile_99.9'])

print(f'\n\n\nTotal runtime is {total_runtime:.1f} seconds, {(total_runtime/3600.0):.1f} hours\n\n')
